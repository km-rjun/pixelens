...
mod tests {
    ...
    #[test]
    fn sanitize_text_empty_input_yields_empty() {
        assert_eq!(sanitize_text("   \n\t\n  "), "");
    }

    #[test]
    fn sanitize_text_single_line_trims_inline_spaces() {
    ...
    fn extract_from_path_missing_file_errors() {
        ...
        if let Ok(engine) = engine {
            let missing = std::path::PathBuf::from("/nonexistent/pixelens-missing-xyz.png");
